...
/// emote sets. Independent of the VOD catalog refresh interval; emote sets
/// change rarely, so this is much slower than the VOD refresh.
pub(crate) const EMOTE_REFRESH_INTERVAL: std::time::Duration =
